...
\begin{center}
  \begin{tabular}{|p{0.3\textwidth}|p{0.3\textwidth}|p{0.3
    ...
    Initial amplitude, $A_0 = 5\si{\cm}$ & So that the damping ratio is not affected by the initial conditions & Pulling the spring down by equal distances for every mass.  Measured by a ruler and hence has uncertainty $\pm 0.1\si{\cm}$                                                   \\ \hline
