...
The observation that the relationship is not perfectly linear is a consequence of the uncertainties that arise from the limitations of measuring devices and human errors. One primary source of random error is the unintentional but inevitable extra force applied when releasing the spring in the liquid. Nonetheless, the mass set did not produce anomolies and massive systematic errors, suggesting that the environment and the experimental setup were controlled effectively. \cref{prop:1} suggested that the expected gradient, $m_0$ would be \begin{align*}
